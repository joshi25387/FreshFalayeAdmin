...
builder.Services.AddScoped<PurchaseReportApiService>();
builder.Services.AddScoped<SaleReportApiService>();
builder.Services.AddScoped<RepackingIssueReportApiService>();
builder.Services.AddScoped<RepackingReceiveReportApiService>();
